...
This rule is triggered when the user types `@inf-devops-platform` and activates the DevOps Infrastructure Specialist Platform Engineer agent persona.
